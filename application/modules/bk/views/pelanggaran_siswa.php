              ...
              <table  class="table table-bordered table-striped" id="example1">
                <thead>
                  <tr>
                    ...
                    <th>Kelas</th>
                    <th>Pelanggaran</th>
                    <?php if(apisms('send_notif_pelanggaran') == 1){ ?>
                    <th>Notif</th>
                    <?php } ?>
                ...
                <tbody>
                  ...
                  <?php foreach ($datapelanggaransiswa as $dt) : ?>
                    <tr>
                      ...
                      <?php if(apisms('send_notif_pelanggaran') == 1){ ?>
                      <td> <?= 
                      ( $dt['status']) == 0 ? '<a href= '.base_url('bk/kirimsms/' . $dt['id']).' class="btn btn-primary btn-xs">Kirim</a>' :'<a href= '.base_url('bk/kirimsms/' . $dt['id']).' class="btn btn-warning btn-xs">Ulang</a>' ?>
                      </td>
                      <?php } ?>
                      <?php if(apiemail('send_notif_pelanggaran') == 1){ ?>
                      <td> <?= 
