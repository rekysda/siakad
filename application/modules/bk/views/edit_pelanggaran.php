...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php $kategori_id = $get_pelanggaran['kategori_id'] ?>
    <!-- Default box -->
    <div class="box">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group <?php echo form_error('kategori_id') ? 'has-error' : '' ?>">
                ...
                <select name="kategori_id" id="kategori_id" class="form-control">
                  ...
                  <option value="<?= $dt['id']; ?>" <?= $dt['id'] == $kategori_id ? ' selected="selected"' : ''; ?>><?= $dt['kategori']; ?></option>
									<?php endforeach; ?>
								</select>
              ...
              <div class="form-group <?php echo form_error('pelanggaran') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="pelanggaran" value="<?= $get_pelanggaran['pelanggaran']; ?>" />
              ...
              <div class="form-group <?php echo form_error('point') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="point" value="<?= $get_pelanggaran['point']; ?>" />
              ...
              <div class="form-group <?php echo form_error('sanksi') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="sanksi" value="<?= $get_pelanggaran['sanksi']; ?>" />
