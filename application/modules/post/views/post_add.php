            ...
            <div class="box-body">
                ...
                <form action="<?php base_url('post/') ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('title') ? 'is-invalid' : '' ?>" type="text" name="title" value="<?= set_value('title'); ?>" />
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input class="form-check-input" type="checkbox" value="1" name="is_publish" id="is_publish" checked> Publish?
                            </label>
                        </div>
                    </div>
