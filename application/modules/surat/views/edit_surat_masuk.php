          ...
          <div class="col-md-4">
            <form action="" method="post">
              <div class="form-group <?php echo form_error('tahun') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="tahun" value="<?= $get_surat_masuk['tahun']; ?>" />
              ...
              <div class="form-group <?php echo form_error('nomor') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="nomor" value="<?= $get_surat_masuk['nomor']; ?>" />
              ...
              <div class="form-group <?php echo form_error('pengirim') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="pengirim" value="<?= $get_surat_masuk['pengirim']; ?>" />
              ...
              <div class="form-group <?php echo form_error('alamat_pengirim') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="alamat_pengirim" value="<?= $get_surat_masuk['alamat_pengirim']; ?>" />
              ...
              <div class="form-group <?php echo form_error('tanggal_masuk') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" id="tanggal_masuk" name="tanggal_masuk" value="<?= $get_surat_masuk['tanggal_masuk']; ?>" />
              ...
              <div class="form-group <?php echo form_error('nomor_surat') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="nomor_surat" value="<?= $get_surat_masuk['nomor_surat']; ?>" />
              ...
              <div class="form-group <?php echo form_error('perihal') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="perihal" value="<?= $get_surat_masuk['perihal']; ?>" />
