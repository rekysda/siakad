        ...
        <form class="form-horizontal" method="post" action="<?= base_url('admin/websetting'); ?>">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="option[email_master]" value="<?= options('email_master') == '' ? set_value('email_master') : options('email_master'); ?>" class="form-control" placeholder="Email Master">
