...
><?= $dt['nama_kelas']; ?> (<?= $dt['tahun']; ?>)</option>
        ...
        <a href="<?= base_url('rapor/jadwal_add'); ?>" class="btn btn-primary">
        Tambahkan</a>&nbsp;&nbsp;
        <a href="<?= base_url('rapor/jadwal_pelajaran_copy'); ?>" class="btn btn-warning">
        Duplicate</a>
    </a>
</form>
        </div>
          ...
          <tbody>
            ...
            foreach ($jadwal_pelajaran as $dt) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('rapor/jadwal_edit/' . $dt['id']); ?>" class="btn btn-info btn-xs">Ubah</a>
                  <a href="<?= base_url('rapor/jadwal_hapus/' . $dt['id']); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin ? data tidak dapat dikembalikan lagi...');">Hapus</a>
                </td>
              </tr>
            <?php endforeach; ?>
          <tbody>
